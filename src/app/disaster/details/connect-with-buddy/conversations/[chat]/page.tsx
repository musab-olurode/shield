...
export default function Page() {
	return (
		<>
			<header className='border-b-2 border-gray-400 shadow-sm shadow-gray-400/10'>
				<div className='container flex items-center gap-x-2 px-2 py-4 '>
					<BackButton />
			...
			<main className='container h-[calc(100vh-5.5rem)] flex flex-col'>
