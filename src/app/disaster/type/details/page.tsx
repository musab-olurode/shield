			...
			<div className='rounded-2xl shadow-sm overflow-hidden flex gap-x-2'>
				...
				<div className='p-2'>
					...
					<p className='text-xs pt-2 text-gray-400 line-clamp-4'>
						...
						that goes through Delta has been flowing at record high levels - it
						was at about 680 feet on Wednesday - and that has inundated nearby
						low-lying areas. Thousands of people have ha
					</p>
				</div>
			</div>
		</main>
